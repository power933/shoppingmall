<%@page import="item.DtoItem"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<% DtoItem di = (DtoItem)request.getAttribute("list"); %>
<div class="detail_title_area">
	<h3 class="name">${list.getPname() }</h3>
	<p class="summary">
		${list.getPsub_ex() }
		<span class="detail_icons">
		</span>
	</p>
	<p class="seq_num Hide">상품번호 : <%=di.getPlarge_cate()+ di.getPsmall_cate() %></p>
</div>
		...
		<div id="goods_thumbs">
			<div class="slides_container hide" style="position:relative;">
					<div class="viewImgWrap">
							<img src="<%=di.getPimg1() %>" title="" alt="상품이미지"/>
					</div>
			</div>
		    ...
		    <ul class="goods_spec_sections">
				...
				<li class="deatil_price_area">
						<div class="deatil_sale_rate">
							<p class="inner">
								<span class="num">${list.getPpercent() }</span>%
							</p>
						</div>
						<p class="org_price">
							<span class="dst_th_size"><s><span class="num"><fmt:formatNumber value="${list.getPprice() }" pattern="#,###" /></span></s>&#x20a9;</span>
						</p>
						<p class="sale_price">
								<span class="num"><fmt:formatNumber value="${list.getPsale() }" pattern="#,###" /></span><span class='price_won'>&#x20a9;</span>
						</p>
				...
				<li class="goods_spec_saving_benefit">
					<ul class="detail_spec_table">
						...
						<li>
							<span designElement="text" textIndex="45" >구매시</span>
							<fmt:formatNumber value="${list.getPsale()*1/100 }" pattern="#,###" />&#x20a9;
	...
	<div class="goods_option_area">
		...
		<tr class="optionTr">
			<td colspan="2">
				...
				<select onchange="selectchange()" id="sel">
					<option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
				...
				<div class="goods_price_area">
					...
					<tr>
						...
						<td class="total_goods_price">
							...
							<span id="total_goods_price"><fmt:formatNumber value="${list.getPsale() }" pattern="#,###" /></span> &#x20a9;
						</td>
					</tr>
					</table>
				</div>
...
function selectchange() {
	...
	var b = ${list.getPsale()};
	total_goods_price.innerHTML = (a*b).toLocaleString('ko-KR') ;
}
</script>
