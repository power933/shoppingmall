...
<ul class="bbs_top_wrap">
    <li class="left">
        <select name="option" id="searchcategory">
            <option value="W" selected="selected">- 전체 -</option>
            <option value="N" >공지</option>
            <option value="E" >긴급공지</option>
        </select>
    </li>
    <li class="right2">
        <span class="searchform">
            <input type="text" name="search" id="search_text" class="res_bbs_search_input" value="" title="제목, 내용" />
...
<ul class="tbody">
<li class="mo_hide">
<span class="mtitle" designElement="text">번호:</span> </li>
<li class="subject">
...
<p>
<!--페이지 번호 반복구간-->
<%--<c:forEach var="i" begin="1" end="${pageea}" step="1">
<a class="on red" href="<c:url value="?page=${i }&search=${param.search}&option=${param.option}"/>">${i }</a>
</c:forEach>--%>
<!--페이지 번호 반복구간-->
</p>
</div>
