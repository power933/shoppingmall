...
<div class="gl_inner_item_wrap">
    ...
    <div class="gli_image goodsDisplayImageWrap">
        <a href="/item?pcode=${recent.pcode}" class="respItemImageArea">
            <img src="${recent.pimg1}" data-src="https://fdumb.com/data/goods/32/2021/09/27921_temp_16329010671170list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='./images1/noimage.gif'" alt="[아쿠아릭] 헤네시 4인소파"/>
        </a>
        <!-- 반응형 모바일 시작 -->
